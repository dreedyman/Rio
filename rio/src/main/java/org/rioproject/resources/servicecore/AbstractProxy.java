...
public abstract class AbstractProxy
    ...
    private void readObject(ObjectInputStream s) throws IOException,
        ...
        if(server == null) {
            throw new InvalidObjectException(
                    "AbstractProxy.readObject failure - "
                            + "server field is null");
        }
        /* Verify uuid */
        if(uuid == null) {
            throw new InvalidObjectException("AbstractProxy.uuid failure - "
                    + "uuid field is null");
        }
    }
    ...
    public EventRegistration register(EventDescriptor descriptor,
        ...
        return (((EventProducer)server).register(descriptor, listener,
                                                 handback, duration));
    }
