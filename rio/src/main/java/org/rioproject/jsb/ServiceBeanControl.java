...
public interface ServiceBeanControl {
     ...
     * ServiceBean
     * @throws JSBControlException If any errors occur
     * @throws RemoteException If any communications errors occur
     */
    Object start() throws JSBControlException, RemoteException;
     ...
     * @throws RemoteException If any communications errors occur
     */
    void stop(boolean force) throws JSBControlException, RemoteException;
     ...
     * @throws RemoteException If any communications errors occur
     */
    void advertise() throws JSBControlException, RemoteException;
     ...
     * @throws RemoteException If any communications errors occur
     */
    void unadvertise() throws JSBControlException, RemoteException;
}
