...
import org.rioproject.boot.PlatformLoader;
...
public class SystemCapabilities implements SystemCapabilitiesLoader {
    ...
    public PlatformCapability[] getPlatformCapabilities(Configuration config) {
        ...
        try {                        
            ...
            processor.define("Available", Integer.toString(
            ...
            List<PlatformCapability> platformCapabilityList =
    ...
    public Map<String, String> getPlatformCapabilityNameTable() {
        ...
        nameTable.put("ConnectivityCapability",
                      CAPABILITY+".connectivity.ConnectivityCapability");
    ...
    public String getPlatformConfigurationDirectory(Configuration config) {
        if(platformConfigDir==null) {
            ...
            String defaultDir = rioHome+File.separator+
    ...
    /*
     * Load the DiskSpace measurable capablity
     */
     ...
     */
    private PlatformCapability[] parsePlatformConfig(PlatformLoader loader,
    ...
    private PlatformCapability[]
        createPlatformCapabilities(PlatformCapabilityConfig[] caps)
        throws Exception {
        ...
        for(int i=0; i<caps.length; i++) {
            ...
            PlatformCapability pCap =
                (PlatformCapability)Class.forName(caps[i].getPlatformClass()).
                                          newInstance();
