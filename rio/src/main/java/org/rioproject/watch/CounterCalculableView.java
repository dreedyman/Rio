 ...
 */
public class CounterCalculableView extends DefaultCalculableView {
    private static final CalculableDisplayAttributes defaultDisplayAttributes = 
     ...
     */
    public CounterCalculableView() {
        super(CounterCalculableView.defaultDisplayAttributes);
    }
     ...
     */
    public CounterCalculableView(CalculableDisplayAttributes calcDisplayAttrs) {
