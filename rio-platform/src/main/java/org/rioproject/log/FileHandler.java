 ...
 * <ul>
 * <li>org.rioproject.log.FileHandler.level specifies the default level for the <tt>Handler</tt>
 *	  (defaults to <tt>Level.ALL</tt>).
 * <li>org.rioproject.log.FileHandler.filter specifies the name of a <tt>Filter</tt> class to use
 *	  (defaults to no <tt>Filter</tt>).
 * <li>org.rioproject.log.FileHandler.formatter specifies the name of a <tt>Formatter</tt> class to use
 *    (defaults to <tt>org.rioproject.log.XMLFormatter</tt>)
 * <li>org.rioproject.log.FileHandler.encoding the name of the character set encoding to use
 *    (defaults to the default platform encoding).
 * <li>org.rioproject.log.FileHandler.limit specifies an approximate maximum amount to write (in bytes)
 * 	  to any one file.  If this is zero, then there is no limit. (Defaults to no limit).
 * <li>org.rioproject.log.FileHandler.count specifies how many output files to cycle through (defaults to 1).
 * <li>org.rioproject.log.FileHandler.pattern specifies a pattern for generating the output file name.  See
 *     below for details. (Defaults to "%h/java%u.log").
 * <li>org.rioproject.log.FileHandler.append specifies whether the FileHandler should append onto
