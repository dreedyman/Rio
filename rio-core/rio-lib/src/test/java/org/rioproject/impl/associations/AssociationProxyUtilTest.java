...
import org.rioproject.impl.associations.AssociationInjector;
import org.rioproject.impl.associations.AssociationProxyUtil;
import org.rioproject.impl.associations.DefaultAssociation;
...
public class AssociationProxyUtilTest {
    ...
    @Before
    public void setup() {
        a = new DefaultAssociation<Dummy>(createAssociationDescriptor("foo"));
        t = new Target();
