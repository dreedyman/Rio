 ...
 * {@link net.jini.config.Configuration} injected. The method on which the
 * SetConfiguration annotation is applied MUST fulfill the following requirements:
 *
 * <ul>
 * <li>The method must have a single parameter of type {@link net.jini.config.Configuration}
