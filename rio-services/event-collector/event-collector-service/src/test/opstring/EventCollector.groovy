...
deployment(name:'Event Collector') {
    ...
    artifact id: 'service-dl',   'org.rioproject.event-collector:event-collector-proxy:5.0-M1'
    artifact id: 'service-impl', 'org.rioproject.event-collector:event-collector-service:5.0-M1'
