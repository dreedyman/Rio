...
deployment(name:'Event Collector') {
    ...
    artifact id: 'service-dl',   'org.rioproject.event-collector:event-collector-proxy:5.0-SNAPSHOT'
    artifact id: 'service-impl', 'org.rioproject.event-collector:event-collector-service:5.0-SNAPSHOT'
