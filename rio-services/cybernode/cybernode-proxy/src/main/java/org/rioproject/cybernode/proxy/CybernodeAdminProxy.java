...
public class CybernodeAdminProxy extends ServiceAdminProxy implements CybernodeAdmin, Serializable {
     ...
     */
    public static CybernodeAdminProxy getInstance(final CybernodeAdmin serviceAdmin, final Uuid id) {
     ...
     * Private constructor
     */
    private CybernodeAdminProxy(final CybernodeAdmin serviceAdmin, final Uuid uuid) {
    ...
    final static class ConstrainableCybernodeAdminProxy extends CybernodeAdminProxy implements RemoteMethodControl {
        ...
        private ConstrainableCybernodeAdminProxy(final CybernodeAdmin serviceAdmin,
                                                 final Uuid id,
    ...
    */
    public void setServiceLimit(final Integer count) throws RemoteException {
     ...
     */
    public void setPersistentProvisioning(final boolean support) throws IOException {
    ...
    public ComputeResourceUtilization getComputeResourceUtilization(final Uuid serviceUuid) throws RemoteException {
