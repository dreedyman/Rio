 ...
 * @author Dennis Reedy
 */
public class ProvisionMonitorProxy extends AbstractProxy implements ProvisionMonitor, Serializable {
     ...
     */
    public static ProvisionMonitorProxy getInstance(final ProvisionMonitor monitor, final Uuid id) {
     ...
     * Private constructor
     */
    private ProvisionMonitorProxy(final ProvisionMonitor monitor, final Uuid id) {
        super(monitor, id);
    ...
    public boolean assignBackupFor(final ProvisionMonitor monitor) throws RemoteException {
