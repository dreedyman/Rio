 ...
 * @author Dennis Reedy
 */
public class CalculableMemoryPoolView extends DefaultCalculableView  {
    private static final CalculableDisplayAttributes
        ...
        new CalculableDisplayAttributes(
            ...
            CalculableMemoryPool.class);
    /**
     * Creates CalculableMemoryView
     */
    public CalculableMemoryPoolView() {
        super(CalculableMemoryPoolView.defaultDisplayAttributes);
    }
     ...
     */
    public CalculableMemoryPoolView(CalculableDisplayAttributes calcDisplayAttrs) {
