...
/**
 * Starts a Cybernode and a Provision Monitor
 *
 * @goal start-all
 *
 * @description Starts a Cybernode and a Provision Monitor
 *
 */
public class StartMojo extends AbstractRioMojo {
    ...
    public void execute() throws MojoExecutionException {
        ...
        ExecHelper.doExec(getRioCommand()+" start all "+overrides, false);
    }
}
