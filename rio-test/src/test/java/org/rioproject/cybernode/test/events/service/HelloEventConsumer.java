 ...
 */
package org.rioproject.cybernode.test.events.service;

import org.rioproject.associations.Association;
import org.rioproject.cybernode.test.events.Hello;
import org.rioproject.cybernode.test.events.HelloEvent;
...
public class HelloEventConsumer {
    ...
    */
     ...
     * of this interface.
     */
    class LocalEventConsumer implements RemoteServiceEventListener<HelloEvent> {
        public void notify(HelloEvent helloEvent) {
            ...
            /*
                ...
                */
            watch.setStartTime(helloEvent.getWhen());
            watch.stopTiming();
        }
    }
}
