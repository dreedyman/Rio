...
class RuleParseTest extends GroovyTestCase {
    ...
    void testRulesAsService() {
        File file = new File("src/test/resources/rules.groovy")
    ...
    void testRulesAsOuter() {
        File file = new File("src/test/resources/rules2.groovy")
        def opstrings = dslParser.parse(file,     // opstring
                                        null,     // parent classloader
                                        false,    // verify
                                        null,     // defaultExportJars
    ...
    void testRulesAsOuterWithService() {
        File file = new File("src/test/resources/rules3.groovy")
        def opstrings = dslParser.parse(file,     // opstring
                                        null,     // parent classloader
                                        false,    // verify
                                        null,     // defaultExportJars
