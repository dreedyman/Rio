...
class OpStringParserTest extends GroovyTestCase {
    ...
    void testLocators() {
        File file = new File("src/test/resources/locators.groovy")
    ...
    void testParameters() {
        File file = new File("src/test/resources/parameters.groovy")
        def opstrings = dslParser.parse(file,     // opstring
                                        null,     // parent classloader
                                        false,    // verify
                                        null,     // defaultExportJars
    ...
    void testSystemRequirements() {
        File file = new File("src/test/resources/systemRequirements_declarations.groovy")
        def opstrings = dslParser.parse(file,     // opstring
                                        null,     // parent classloader
                                        false,    // verify
                                        null,     // defaultExportJars
    ...
    void testEmptyResources() {
        File file = new File("src/test/resources/bean_empty.groovy")
        def opstrings = dslParser.parse(file,     // opstring
                                        null,     // parent classloader
                                        false,    // verify
                                        null,     // defaultExportJars
    ...
    void testSpringDM() {
        File file = new File("src/test/resources/springDM.groovy")
        def opstrings = dslParser.parse(file,     // opstring
                                        null,     // parent classloader
                                        false,    // verify
                                        null,     // defaultExportJars
    ...
    void testGroovyIncludes() {
        File file = new File("src/test/resources/outer.groovy")
        def opstrings = dslParser.parse(file,     // opstring
                                        null,     // parent classloader
                                        false,    // verify
                                        null,     // defaultExportJars
    ...
    void testDownloads() {
        testDownloadsFromSource dslParser, new File("src/test/resources/download.groovy")
        testDownloadsFromSource xmlParser, new File("src/test/resources/download.xml")
    }
    ...
    void testMultiGroovyIncludes() {
        File file = new File("src/test/resources/outer_multi.groovy")
        def opstrings = dslParser.parse(file,     // opstring
                                        null,     // parent classloader
                                        false,    // verify
                                        null,     // defaultExportJars
    ...
    void testXmlParserOnSimpleBeanExample() {
        testXmlParserOnSimpleBeanExampleFromSource xmlParser, new File("src/test/resources/bean.xml")
        testXmlParserOnSimpleBeanExampleFromSource xmlParser,new URL("file:src/test/resources/bean.xml")
        testXmlParserOnSimpleBeanExampleFromSource dslParser, new File("src/test/resources/bean.groovy")
    }
    ...
    void testXmlParserOnCalculatorExample() {
        testXmlParserOnCalculatorExampleOnFile xmlParser, new File("src/test/resources/calculator.xml")
        testXmlParserOnCalculatorExampleOnFile dslParser, new File("src/test/resources/calculator.groovy")
        testXmlParserOnCalculatorExampleOnFile dslParser, new File("src/test/resources/calculator2.groovy")
        testXmlParserOnCalculatorExampleOnFile dslParser, new File("src/test/resources/calculator_artifacts.groovy")
    }
    ...
    void testXmlParserOnEventsExample() {
        testXmlParserOnEventsExampleFromFile xmlParser, new File("src/test/resources/events.xml")
//        testXmlParserOnEventsExampleFromFile dslParser, new File("src/test/resources/events.groovy")
    }
    ...
    void testXmlParserOnServiceBeanExample() {
        testXmlParserOnServiceBeanExampleFromFile xmlParser, new File("src/test/resources/servicebean.xml")
        testXmlParserOnServiceBeanExampleFromFile dslParser, new File("src/test/resources/servicebean.groovy")
    }
    ...
    void testXmlParserOnSpringBeanExample() {
        testXmlParserOnSpringBeanExampleFromFile xmlParser, new File("src/test/resources/springbean.xml")
        testXmlParserOnSpringBeanExampleFromFile dslParser, new File("src/test/resources/springbean.groovy")
    }
    ...
    void testXmlParserOnTomcatDeployment() {
        testXmlParserOnTomcatDeploymentFromFile xmlParser, new File("src/test/resources/tomcat.xml")
        testXmlParserOnTomcatDeploymentFromFile dslParser, new File("src/test/resources/tomcat.groovy")
    }
    ...
    void testXmlParserOnOutriggerLite() {
        testXmlParserOnOutriggerLiteFromFile xmlParser, new File("src/test/resources/outrigger_lite.xml")
        testXmlParserOnOutriggerLiteFromFile dslParser, new File("src/test/resources/outrigger_lite.groovy")
    }
    ...
    void testXmlParserOnOutrigger() {
        testXmlParserOnOutriggerFromFile xmlParser, new File("src/test/resources/outrigger.xml")
        testXmlParserOnOutriggerFromFile dslParser, new File("src/test/resources/outrigger.groovy")
    }
    ...
    void testXmlParserOnRioExampleForGettingStartedGuide() {
        testXmlParserOnRioExampleForGettingStartedGuideFromFile xmlParser, new File("src/test/resources/rio-example.xml")
        testXmlParserOnRioExampleForGettingStartedGuideFromFile dslParser, new File("src/test/resources/rioexample.groovy")
    }
    void testXmlParserOnRioExampleForGettingStartedGuideFromFile(parser, file) {
        ...
        assertEquals 'org.rioproject.sla.ScalingPolicyHandler', rateSLA.slaPolicyHandler
        ...
        assertEquals 'org.rioproject.sla.SLAPolicyHandler', throughtputSLA.slaPolicyHandler
        ...
        assertEquals 'org.rioproject.sla.ScalingPolicyHandler', backlogSLA.slaPolicyHandler
    ...
    void testXmlParserOnGridSampleForGettingStartedGuide() {
        testXmlParserOnGridSampleForGettingStartedGuideFromFile xmlParser, new File("src/test/resources/grid.xml")
        testXmlParserOnGridSampleForGettingStartedGuideFromFile dslParser, new File("src/test/resources/grid.groovy")
    }
    ...
    void testXmlParserOnTerracotaServerDeployment() {
        testXmlParserOnTerracotaServerDeploymentFromFile xmlParser, new File("src/test/resources/terracotta-server.xml")
        testXmlParserOnTerracotaServerDeploymentFromFile dslParser, new File("src/test/resources/terracottaServer.groovy")
    }
    ...
    void testXmlParserOnTerracotaClientDeployment() {
        testXmlParserOnTerracotaClientDeploymentFromFile xmlParser, new File("src/test/resources/terracotta-client.xml")
        testXmlParserOnTerracotaClientDeploymentFromFile dslParser, new File("src/test/resources/terracottaClient.groovy")
    }
    ...
    void testXmlParserOnMuves() {
        testXmlParserOnMuvesFromFile xmlParser, new File("src/test/resources/muves.rio.xml")
        testXmlParserOnMuvesFromFile dslParser, new File("src/test/resources/muves.rio.groovy")
    }
