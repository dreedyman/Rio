...
/**
 * Extends {@link org.rioproject.core.OperationalStringManager} and provides additional support for
...
public interface OpStringManager  {
     ...
     *
     * @throws org.rioproject.core.OperationalStringException if there are errors updating
     */
     ...
     *
     * @throws org.rioproject.core.OperationalStringException if there are errors during removal
     */
     ...
     * @param listener Provide a listener for notification
     * @throws org.rioproject.core.OperationalStringException if there are errors during redeployment
     */
