...
public class JavaEntityResolver implements EntityResolver {
    ...
    /** Logger instance  */
    private final static Logger logger = Logger.getLogger("org.rioproject.resources.util");
    ...
    public InputSource resolveEntity(final String publicId, final String systemIdentifier)
        throws SAXException, IOException {
        if(publicId != null) {
            if(logger.isLoggable(Level.FINE)) {
                logger.log(Level.FINE,
                           "Looking for public {0}, java:// for public is not yet implemented",
                           new Object[] {publicId});
        ...
        String systemId = systemIdentifier;
        if(systemId == null) {
            return null;
        }
            ...
            if((paren = target.indexOf('(')) > 2) {
                ...
                try {
                    ...
                    for(Enumeration en=methodTable.keys();
                        ...
                        String[] paramParts = getParamParts((String)methodTable.get(key));
                        if(paramParts.length ==0) {
                            ...
                            System.arraycopy(paramParts, 0, paramArgs, 0, paramArgs.length);
                        }
