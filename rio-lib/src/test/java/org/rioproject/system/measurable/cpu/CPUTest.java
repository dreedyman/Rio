...
public class CPUTest {
    @Test
    public void createAndVerifyCPUClass() {
    ...
    @Test
    public void createAndVerifyCPUWithLowerThresholdBeingCrossed() {
        CPU cpu = new CPU(EmptyConfiguration.INSTANCE);
    ...
    @Test
    public void createAndVerifyCPUWithUpperThresholdBeingCrossed() {
        CPU cpu = new CPU(EmptyConfiguration.INSTANCE);
