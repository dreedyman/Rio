...
deployment(name: 'Hospital') {
    ...
    artifact id: 'service', 'org.rioproject.examples.hospital:hospital-service:2.3.4'
    artifact id: 'service-dl', 'org.rioproject.examples.hospital:hospital-api:2.3.4'
    ...
    rules {
        rule {
            ...
            ruleClassPath 'org.rioproject.examples.hospital:hospital-rule:2.3.4'
