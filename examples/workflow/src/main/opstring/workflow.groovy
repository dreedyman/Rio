...
deployment(name: 'Workflow Example') {
    ...
    artifact id: 'service-impl',   'org.rioproject.examples.workflow:workflow-service:2.3.4'
    artifact id: 'service-dl',     'org.rioproject.examples.workflow:workflow-api:2.3.4'
