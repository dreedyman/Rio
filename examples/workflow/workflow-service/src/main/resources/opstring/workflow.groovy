...
deployment(name: 'Workflow Example') {
    ...
    artifact id: 'service-impl',   'org.rioproject.examples.workflow:workflow-service:@version@'
    artifact id: 'service-dl',     'org.rioproject.examples.workflow:workflow-api:@version@'
