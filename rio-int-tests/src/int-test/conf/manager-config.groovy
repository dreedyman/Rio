...
manager {
    ...
    reggieStarter    = '${rio.test.home}${/}src${/}int-test${/}conf${/}start-reggie.groovy'

    monitorStarter   = '${rio.test.home}${/}src${/}int-test${/}conf${/}start-monitor.groovy'

    cybernodeStarter = '${rio.home}${/}config${/}start-cybernode.groovy'

    //config = '${rio.home}${/}config${/}tools.groovy'

    harvesterOpString = '${rio.test.home}${/}src${/}int-test${/}resources${/}harvester.groovy'

    harvestDir = '${rio.test.home}${/}build{/}harvested${/}logs'
